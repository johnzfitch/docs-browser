...
The rightmost boundary the cursor can move to is determined by the current cursor column and the [right margin](https://ghostty.org/docs/features/theme#TODO). If the cursor begins to the right of the right margin, modify the right margin to be the rightmost column of the screen for the duration of the sequence. The rightmost column the cursor can be on is the right margin.
...
-   [
    ...
    ](https://ghostty.org/docs/features/theme#cuf-v-1:-pending-wrap-is-unset)
-   [
    
    CUF V-2: Rightmost Boundary with Reverse Wrap Disabled
    
    ](https://ghostty.org/docs/features/theme#cuf-v-2:-rightmost-boundary-with-reverse-wrap-disabled)
-   [
    
    CUF V-3: Left of the Right Margin
    
    ](https://ghostty.org/docs/features/theme#cuf-v-3:-left-of-the-right-margin)
-   [
    
    CUF V-4: Right of the Right Margin
    
    ](https://ghostty.org/docs/features/theme#cuf-v-4:-right-of-the-right-margin)
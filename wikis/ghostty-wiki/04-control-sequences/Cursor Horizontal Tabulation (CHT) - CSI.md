...
The rightmost valid column for this operation is the rightmost column in the terminal screen or the [right margin](https://ghostty.org/docs/config/keybind#TODO), whichever is smaller. This sequence does not change behavior with [origin mode](https://ghostty.org/docs/config/keybind#TODO) set.
...
Tabstops are dynamic and can be set with escape sequences such as [horizontal tab set (HTS)](https://ghostty.org/docs/config/keybind#TODO), [tab clear (TBC)](https://ghostty.org/docs/vt/csi/tbc), etc. A terminal emulator may default tabstops at any interval, though an interval of 8 spaces is most common.
...
-   [
    ...
    ](https://ghostty.org/docs/config/keybind#cht-v-1:-right-beyond-last-column)
-   [
    
    CHT V-2: Right From Before a Tabstop
    
    ](https://ghostty.org/docs/config/keybind#cht-v-2:-right-from-before-a-tabstop)
-   [
    
    CHT V-3: Right Margin
    
    ](https://ghostty.org/docs/config/keybind#cht-v-3:-right-margin)
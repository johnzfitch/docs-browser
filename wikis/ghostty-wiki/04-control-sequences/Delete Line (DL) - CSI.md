...
If the current cursor position is outside of the current scroll region, this sequence does nothing. The cursor is outside of the current scroll region if it is above the [top margin](https://ghostty.org/docs/vt#TODO), below the [bottom margin](https://ghostty.org/docs/vt#TODO), left of the [left margin](https://ghostty.org/docs/vt#TODO), or right of the [right margin](https://ghostty.org/docs/vt#TODO).
...
If a [left margin](https://ghostty.org/docs/vt#TODO) or [right margin](https://ghostty.org/docs/vt#TODO) is set, only the cells within and including the margins are deleted or shifted. Other existing contents to the left of the left margin or right of the right margin remains untouched.
...
-   [
    ...
    ](https://ghostty.org/docs/vt#dl-v-1:-simple-delete-line)
-   [
    
    DL V-2: Cursor Outside of Scroll Region
    
    ](https://ghostty.org/docs/vt#dl-v-2:-cursor-outside-of-scroll-region)
-   [
    
    DL V-3: Top/Bottom Scroll Regions
    
    ](https://ghostty.org/docs/vt#dl-v-3:-topbottom-scroll-regions)
-   [
    
    DL V-4: Left/Right Scroll Regions
    
    ](https://ghostty.org/docs/vt#dl-v-4:-leftright-scroll-regions)
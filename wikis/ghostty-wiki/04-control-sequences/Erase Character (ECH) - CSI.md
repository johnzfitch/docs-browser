...
The rightmost column that can be erased is the rightmost column of the screen. The [right margin](https://ghostty.org/docs/config/keybind#) has no effect on this sequence.
...
-   [
    ...
    ](https://ghostty.org/docs/config/keybind#ech-v-1:-simple-operation)
-   [
    
    ECH V-2: Erasing Beyond Edge of Screen
    
    ](https://ghostty.org/docs/config/keybind#ech-v-2:-erasing-beyond-edge-of-screen)
-   [
    
    ECH V-3: Reset Pending Wrap State
    
    ](https://ghostty.org/docs/config/keybind#ech-v-3:-reset-pending-wrap-state)
-   [
    
    ECH V-4: SGR State
    
    ](https://ghostty.org/docs/config/keybind#ech-v-4:-sgr-state)
-   [
    
    ECH V-5: Multi-cell Character
    
    ](https://ghostty.org/docs/config/keybind#ech-v-5:-multi-cell-character)
-   [
    
    ECH V-6: Left/Right Scroll Region Ignored
    
    ](https://ghostty.org/docs/config/keybind#ech-v-6:-leftright-scroll-region-ignored)
-   [
    
    ECH V-7: Protected Attributes Ignored with DECSCA
    
    ](https://ghostty.org/docs/config/keybind#ech-v-7:-protected-attributes-ignored-with-decsca)
-   [
    
    ECH V-8: Protected Attributes Respected without DECSCA
    
    ](https://ghostty.org/docs/config/keybind#ech-v-8:-protected-attributes-respected-without-decsca)
...
If the cursor position is outside of the [left and right margins](https://ghostty.org/docs/vt#TODO), this sequence does not change the screen, but the pending wrap state is still reset.
...
-   [
    ...
    ](https://ghostty.org/docs/vt#ich-v-1:-no-scroll-region-fits-on-screen)
-   [
    
    ICH V-2: SGR State
    
    ](https://ghostty.org/docs/vt#ich-v-2:-sgr-state)
-   [
    
    ICH V-3: Shifting Content Off the Screen
    
    ](https://ghostty.org/docs/vt#ich-v-3:-shifting-content-off-the-screen)
-   [
    
    ICH V-4: Inside Left/Right Scroll Region
    
    ](https://ghostty.org/docs/vt#ich-v-4:-inside-leftright-scroll-region)
-   [
    
    ICH V-5: Outside Left/Right Scroll Region
    
    ](https://ghostty.org/docs/vt#ich-v-5:-outside-leftright-scroll-region)
-   [
    
    ICH V-6: Split Wide Character
    
    ](https://ghostty.org/docs/vt#ich-v-6:-split-wide-character)
...
-   Pending wrap state
-   SGR attributes
-   [Origin mode (DEC Mode 6)](https://ghostty.org/docs/vt#TODO)
...
-   [
    ...
    ](https://ghostty.org/docs/vt#sc-v-1:-cursor-position)
-   [
    
    SC V-2: Pending Wrap State
    
    ](https://ghostty.org/docs/vt#sc-v-2:-pending-wrap-state)
-   [
    
    SC V-3: SGR Attributes
    
    ](https://ghostty.org/docs/vt#sc-v-3:-sgr-attributes)
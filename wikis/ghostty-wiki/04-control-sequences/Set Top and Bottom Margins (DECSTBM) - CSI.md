...
This sequence unsets the pending wrap state and moves the cursor to the top-left of the screen. If [origin mode](https://ghostty.org/docs/config/keybind#TODO) is set, the cursor is moved to the top-left of the scroll region.
...
-   [
    ...
    ](https://ghostty.org/docs/config/keybind#decstbm-v-1:-full-screen)
-   [
    
    DECSTBM V-2: Top Only
    
    ](https://ghostty.org/docs/config/keybind#decstbm-v-2:-top-only)
-   [
    
    DECSTBM V-3: Top and Bottom
    
    ](https://ghostty.org/docs/config/keybind#decstbm-v-3:-top-and-bottom)
-   [
    
    DECSTBM V-4: Top Equal to Bottom
    
    ](https://ghostty.org/docs/config/keybind#decstbm-v-4:-top-equal-to-bottom)
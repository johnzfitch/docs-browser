...
Control characters are single byte characters that have a special meaning. They have no encoding format; you send the bytes as-is. For example, [backspace](https://ghostty.org/docs/vt/control/bs) is `0x08`, [linefeed](https://ghostty.org/docs/vt/control/lf) is `0x0A`, etc.
...
-   [
    ...
    ](https://ghostty.org/docs/vt#control-characters)
-   [
    
    Escape Sequences
    
    ](https://ghostty.org/docs/vt#escape-sequences)
-   [
    
    CSI Sequences
    
    ](https://ghostty.org/docs/vt#csi-sequences)
-   [
    
    OSC Sequences
    
    ](https://ghostty.org/docs/vt#osc-sequences)
-   [
    
    DCS Sequences
    
    ](https://ghostty.org/docs/vt#dcs-sequences)
-   [
    
    APC Sequences
    
    ](https://ghostty.org/docs/vt#apc-sequences)
-   [
    
    SOS and PM Sequences
    
    ](https://ghostty.org/docs/vt#sos-and-pm-sequences)
...
The default behavior of Ghostty is to use GTK single instance mode **when _not_ launched from a CLI environment.**
...
-   [
    ...
    ](https://ghostty.org/docs/vt#cli-environment-detection)
-   [
    
    Forcing GTK Single Instance Mode On or Off
    
    ](https://ghostty.org/docs/vt#forcing-gtk-single-instance-mode-on-or-off)
-   [
    
    Relationship to Startup Performance and Memory
    
    ](https://ghostty.org/docs/vt#relationship-to-startup-performance-and-memory)
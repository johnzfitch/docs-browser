...
-   [
    ...
    Download a source tarball and build Ghostty from source.
...
-   [
    ...
    ](https://ghostty.org/docs/config/keybind#installing-on-linux)
-   [
    
    Supported GTK/Adwaita Versions
    
    ](https://ghostty.org/docs/config/keybind#supported-gtkadwaita-versions)
-   [
    
    Policy
    
    ](https://ghostty.org/docs/config/keybind#policy)
-   [
    
    Other Dependencies
    
    ](https://ghostty.org/docs/config/keybind#other-dependencies)